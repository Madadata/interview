...
我们首先将进行45分钟的在线标准技术面试，考察工程师的基本能力。具体的面试方法我们写在了[这里](https://github.com/Madadata/interview/blob/master/Interview%20Guide/PhoneInterview.md)。

当通过了标准技术面试，你将被邀请参加我们的「试用工作」面试，面试的方法我们写在了[这里](https://github.com/Madadata/interview/blob/master/Interview%20Guide/ProjectInterview.md)。
