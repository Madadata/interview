...
我们首先将进行45分钟的在线标准技术面试，考察工程师的基本能力。具体的面试方法我们写在了[这里](https://github.com/Madadata/interview/blob/master/PhoneInterview.md)。

当通过了标准技术面试，你将被邀请参加我们的「试用工作」面试，具体的方法是由面试参与者和我们的团队一起商量一个对于大家来讲都比较新又都比较感兴趣的小项目，在三天到一周的时间内，由面试者*主导*，我们*参与*和*提供支持*，一起完成项目。我们对面试用到的具体技术、语言、框架等不做太多限制。但是我们想强调的是以下几点：
