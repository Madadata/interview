...
- 我们的[在线项目](https://hangman.leanapp.cn)是一个需要用编程完成的小游戏。请先发送你的个人简介或者简历到我们的[邮箱](mailto://hi@madadata.com)，我们会为你创建一个账户。你需要在一定时间内，独立地编程完成这个游戏项目，并且把你最好成绩的截图、源代码、日志等打包发送给我们，我们会根据代码质量、风格和成绩综合考虑，然后要求你参与我们的现场面试
- 我们的现场面试可能是[项目面试](https://github.com/Madadata/interview/blob/master/InterviewGuide/ProjectInterview.md)的形式，也可能是别的形式——但我们都会邀请你来我们的办公室当面沟通，同时给你展示我们公司目前的 Demo 和公司文化。
